% Header and Footer
\pagestyle{fancy}
\lhead{\tikz[baseline=(X.base)] \node[fill=cyan!80!blue, text=white, font=\bfseries, rounded corners=5pt, inner sep=5pt] (X) {Object-Oriented Programming};}
\rhead{\textbf{Library Management System}}
\lfoot{\textbf{Group 3 | Class 24C06}}
\cfoot{}
